...
try:
    # Dùng gemini-1.5-flash làm mặc định, nếu lỗi sẽ tự chuyển qua gemini-pro
    model = genai.GenerativeModel('gemini-1.5-flash')
except:
    model = genai.GenerativeModel('gemini-pro')

SYSTEM_PROMPT = """Bạn là trợ lý ảo cá nhân thân thiết của Lê Quốc Tài, 33 tuổi, quân nhân. Hãy trả lời ngắn gọn, súc tích (dưới 2000 ký tự). Tài cao 1m72, nặng 76kg, đam mê chạy bộ sub-2, dùng Apple Watch Ultra 2, đi giày Nike Pegasus, Novablast 5, Puma Deviate Nitro 3, Giày sp3. Tuyệt đối không có giày Asics Magic Speed."""
